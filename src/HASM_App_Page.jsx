...
const logger = createLogger('hasm-app-page');

const hasmAppPageStyles = `
  .HASM_Page {
    min-height: 100vh;
    display: flex;
...
export const HASM_App_Page = ({ onNavigateHome }) => {
  ...
  const handleTabChange = (tabId) => {
    setActiveTab(tabId);
    logger.info('Changed HASM app page tab.', { tabId });
  };
      ...
      <div className="HASM_Page_Inner">
        ...
        <main>
          ...
          <section className="HASM_Page_Hero">
            ...
            {/* TAB NAVIGATION */}
            <nav className="HASM_Page_TabNav" aria-label="HASM app navigation">
              <button
                type="button"
