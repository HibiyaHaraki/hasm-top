...
const TRANSLATIONS = {
  en: {
    ...
    downloadSubtitle: 'Download native installer packages (.msi, .dmg, .deb, .AppImage) or portable standalone archives for your OS.',
    winTitle: 'Windows 10 / 11 (64-bit)', winMsi: 'Download .msi Installer', winZip: 'Download Portable .zip',
    macTitle: 'macOS (Universal / Apple Silicon)', macDmg: 'Download .dmg Installer', macTar: 'Download Portable .tar.gz',
    linuxTitle: 'Linux (Ubuntu / Debian / Fedora)', linuxAppImage: 'Download .AppImage', linuxDeb: 'Download .deb Package',
  ...
  ja: {
    ...
    downloadSubtitle: 'お使いのOSに応じたネイティブインストーラー（.msi, .dmg, .deb, .AppImage）またはポータブル版をダウンロードできます。',
    winTitle: 'Windows 10 / 11 (64-bit)', winMsi: '.msi インストーラーをダウンロード', winZip: 'ポータブル .zip をダウンロード',
    macTitle: 'macOS (Apple Silicon / Intel)', macDmg: '.dmg インストーラーをダウンロード', macTar: 'ポータブル .tar.gz をダウンロード',
    linuxTitle: 'Linux (Ubuntu / Debian / Fedora)', linuxAppImage: '.AppImage をダウンロード', linuxDeb: '.deb パッケージをダウンロード',
